  ...
  const SOCIALS = [
    {
      ...
      socialColor: '#00AAEC',
      path: links.twitter || 'https://discord.com/invite/7gBMZgUnmm',
    },
    {
      name: 'Twitter',
      icon: 'eva:twitter-fill',
      socialColor: '#00AAEC',
      path: links.twitter || 'https://twitter.com/embogoapp',
    },
    {
      name: 'Instagram',
      icon: 'ant-design:instagram-filled',
      socialColor: '#E02D69',
      path: links.instagram || 'https://www.instagram.com/embogoapp/',
    },
