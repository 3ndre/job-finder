...
import { Box, Grid, Container, Typography, Button, Tooltip, TextField, Collapse, Card, CardContent, CardActions, IconButton, InputAdornment} from '@mui/material';
...
<form onSubmit={handleNavigate}>
        ...
        Find Your Dream Job In <div> Simple Steps</div>
            ...
            <Card sx={{ maxWidth: 345, padding: 1 }}>
              <CardContent>
              <TextField InputProps={{endAdornment: <InputAdornment position="start"><Iconify icon="material-symbols:search" /></InputAdornment>}} label="Search" variant="outlined" fullWidth  autoComplete='off' onChange={e => setSearchData({...searchData, title: e.target.value})} value={searchData.title}/>
              </CardContent>
