...
import { Box, Link, Grid, List, Stack, Popover, ListItem, ListItemIcon } from '@mui/material';
// components
...
function MenuDesktopItem({ item, isHome, isOpen, isOffset}) {
